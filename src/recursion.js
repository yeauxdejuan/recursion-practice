...
var capitalizeFirst = (array)=> {
  ...
  let arrayy = array[0]
  return [arrayy[0].toUpperCase() + arrayy.slice(1), ...capitalizeFirst(array.slice(1))]
...
var numToText = (str) =>{
  ...
  if (str.length === 0) {
    ...
    return words[str[0]] + "" + numToText(str.slice(1));
  } else {
